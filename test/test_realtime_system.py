...
try:
    ...
    from backend.feature_engineering_realtime import realtime_feature_extractor, RealTimeFeatureExtractor
...
async def test_realtime_database():
    ...
    if not enhanced_db_manager.is_connected():
        print("⚠️ Database not connected - skipping database tests")
        return True
