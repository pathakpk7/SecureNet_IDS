...
class CSVLogger:
    ...
    def write_log(self, log_data: Dict[str, Any]) -> bool:
        ...
        """
        try:
            if 'ip_address' not in log_data and 'source_ip' in log_data:
                log_data['ip_address'] = log_data['source_ip']
            if 'risk_level' in log_data and hasattr(log_data['risk_level'], 'value'):
                log_data['risk_level'] = log_data['risk_level'].value
            if 'attack_type' in log_data and hasattr(log_data['attack_type'], 'value'):
                log_data['attack_type'] = log_data['attack_type'].value
